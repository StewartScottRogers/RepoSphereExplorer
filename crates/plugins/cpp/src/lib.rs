...
pub const EXTENSIONS: &[&str] = &["cpp", "cc", "cxx", "hpp", "hh"];
...
mod tests {
    ...
    fn both_halves_claim_the_same_extensions() {
        assert_eq!(
            plugin_api::PluginCore::extensions(&crate::CppCore),
            plugin_api::PluginPresentation::extensions(&crate::CppPresentation),
