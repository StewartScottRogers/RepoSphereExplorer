...
pub const EXTENSIONS: &[&str] = &["pro", "plg"];
...
/// told.
const PROLOG: Language = Language {
    line_comment: &["%"],
    block_comment: &[("/*", "*/")],
...
mod tests {
    ...
    fn both_halves_claim_the_same_extensions() {
        assert_eq!(
            plugin_api::PluginCore::extensions(&crate::PrologCore),
            plugin_api::PluginPresentation::extensions(&crate::PrologPresentation),
