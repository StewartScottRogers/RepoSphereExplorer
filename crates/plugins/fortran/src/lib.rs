...
pub const EXTENSIONS: &[&str] = &["f", "f90", "f95", "for"];
...
mod tests {
    ...
    fn both_halves_claim_the_same_extensions() {
        assert_eq!(
            plugin_api::PluginCore::extensions(&crate::FortranCore),
            plugin_api::PluginPresentation::extensions(&crate::FortranPresentation),
