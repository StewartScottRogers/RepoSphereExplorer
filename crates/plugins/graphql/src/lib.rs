...
pub const EXTENSIONS: &[&str] = &["graphql", "gql"];
...
mod tests {
    ...
    fn both_halves_claim_the_same_extensions() {
        assert_eq!(
            plugin_api::PluginCore::extensions(&crate::GraphQlCore),
            plugin_api::PluginPresentation::extensions(&crate::GraphQlPresentation),
