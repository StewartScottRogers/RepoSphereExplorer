...
pub const EXTENSIONS: &[&str] = &["tf", "tfvars"];
...
mod tests {
    ...
    fn both_halves_claim_the_same_extensions() {
        assert_eq!(
            plugin_api::PluginCore::extensions(&crate::TerraformCore),
            plugin_api::PluginPresentation::extensions(&crate::TerraformPresentation),
