...
pub const EXTENSIONS: &[&str] = &["obj", "stl", "ply", "gltf", "glb"];
...
";
    ...
    fn both_halves_claim_the_same_extensions() {
        assert_eq!(
            plugin_api::PluginCore::extensions(&crate::Model3dCore),
            plugin_api::PluginPresentation::extensions(&crate::Model3dPresentation),
