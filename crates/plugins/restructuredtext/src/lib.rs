...
mod tests {
    ...
    fn both_halves_claim_the_same_extensions() {
        assert_eq!(
            plugin_api::PluginCore::extensions(&crate::RestructuredTextCore),
            plugin_api::PluginPresentation::extensions(&crate::RestructuredTextPresentation),
